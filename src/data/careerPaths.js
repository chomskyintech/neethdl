export const careerPaths={
  'rtl-digital':{
    ...
    projectSlugs:['guided-risc-v-cpu','asynchronous-fifo','pipelined-risc-v-core','cache-memory-controller','axi-lite-apb-bridge','dma-engine','small-risc-v-soc'],
    milestones:[
      {title:'1. RTL fundamentals',problemIds:['rtl-mux','rtl-priority','rtl-counter','rtl-shift-register','rtl-edge-detector']},
      {title:'2. Control and state',problemIds:['rtl-arbiter','rtl-round-robin-arbiter','rtl-onehot-fsm','rtl-regfile']},
  ...
  'verification':{
    ...
    projectSlugs:['apb-peripheral-verification','uvm-axi4-lite-verification','risc-v-core-verification'],
  },
  'hft-fpga':{
    id:'hft-fpga',
    slug:'fpga-engineer',
    ...
    projectSlugs:['uart-spi-i2c-controller','hardware-dsp-pipeline','fpga-packet-parser','low-latency-market-data-parser'],
  },
  'cpu-gpu':{
    id:'cpu-gpu',
  ...
  'accelerators':{
    ...
    projectSlugs:['hardware-dsp-pipeline','fpga-packet-parser','feed-to-action-latency-pipeline'],
  },
}
