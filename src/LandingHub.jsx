...
export default function LandingHub({go,problemCount,solvedCount}){
 return <div className="landing-hub">
  <section className="hero landing-hero">
   ...
   <h1>Prepare for hardware roles.<br/><span>Learn, practice, interview, build.</span></h1>
   <p>Choose how you want to prepare: follow a course, solve HDL problems, use a role track, run timed interview practice, or build portfolio projects.</p>
  </section>
