...
<style>body{font-family:system-ui,-apple-system,Segoe UI,sans-serif;max-width:980px;margin:0 auto;padding:48px 24px;line-height:1.65;color:#f4f4f5;background:#1d1c1e}nav{margin-bottom:38px}h1{font-size:2.4rem;line-height:1.1;letter-spacing:-.03em}h2{margin-top:2.3rem}.intro{font-size:1.08rem;max-width:800px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px}.card{display:block;border:1px solid #3a393d;background:#262527;border-radius:12px;padding:17px;text-decoration:none;color:inherit}.card:hover{border-color:#615fff}.meta{color:#aaa8ad;font-size:.9rem}.category{margin-top:2.6rem}.problem-list{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:10px}.problem{display:block;border:1px solid #3a393d;background:#262527;border-radius:9px;padding:13px;text-decoration:none;color:inherit}.problem strong{display:block}.problem span{color:#aaa8ad;font-size:.88rem}</style>
