...
test.describe('guided project catalog',()=>{
  ...
  test('groups buildable projects under career titles',async({page})=>{
    ...
    await expect(page.getByRole('heading',{name:'SoC Design / Integration Engineer'})).toBeVisible()
    await expect(page.getByRole('heading',{name:'Formal Verification Engineer'})).toBeVisible()
